    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PriceConditions", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PriceConditions_Cars_CarId",
                        column: x => x.CarId,
                        principalTable: "Cars",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_PriceConditions_Seasons_SeasonId",
                        column: x => x.SeasonId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PriceConditions_CarId",
                table: "PriceConditions",
                column: "CarId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceConditions_SeasonId",
                table: "PriceConditions",
                column: "SeasonId");

            migrationBuilder.CreateIndex(
                name: "IX_PriceConditions_TariffId",
                table: "PriceConditions",
                column: "TariffId");
